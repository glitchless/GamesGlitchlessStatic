...
client_download_url = "https://f003.backblazeb2.com/file/lionzxy-static-files/GT_New_Horizons_2.8.4_Client_Java_8.zip"
...
def remove_unsupported():
    os.remove(unzipped_modpack_folder + "mods/ServerUtilities-2.2.2.jar")
